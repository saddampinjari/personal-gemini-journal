 ...
 * Step 1: gemini-3.6-flash (Primary fast, high-quality multimodal reasoning)
 * Step 2: gemini-3.1-flash-lite (High-availability resilient serving tier)
 * Step 3: gemini-2.5-flash (Reliable long-context fallback)
 */
